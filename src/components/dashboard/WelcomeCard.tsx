...
export default function WelcomeCard({ user }) {
  ...
  const motivationalMessages = [
    ...
    "הגוף שלך אוהב אותך על השמירה על בריאות! 💚",
    "היום תהיי החזקה ביותר שלך! 🔥",
    "האנרגיה שלך מדבקת! תמשיכי לזרוח! ⭐",
    "כל אימון מקרב אותך למטרה! המשיכי קדימה! 🚀",
    "את השראה אמיתית! גאים בך! 🌟",
    "הגוף והנפש שלך מודים לך על הטיפול! 🧘‍♀️",
    "היום יהיה מלא באנרגיות חיוביות! 🌈",
    "את חזקה מכל מכשול! תאמיני בעצמך! 💎",
    "כל ארוחה בריאה היא השקעה בעתיד שלך! 🥗",
    "המסע שלך הוא מדהים! תמשיכי ליהנות! 🎯",
    "את שווה את כל המאמץ! תאהבי את עצמך! 💕",
    "הדרך שלך ייחודית ומשמעותית! 🌺",
    "כל יום הוא הזדמנות חדשה להצליח! 🌅",
    "האיזון שלך בין גוף לנפש מושלם! ⚖️",
    "את מלאה בכוח ובנחישות! קדימה! 🦋",
    "התזונה הנכונה היא דלק לחיים! 🍎",
    "את יוצרת את המציאות הטובה ביותר! 🎨",
    "כל טיפה מים מזינה את התאים שלך! 💧",
    "הכוח האמיתי מתחיל בראש! את מסוגלת! 🧠",
    "הגוף שלך הוא המקדש שלך! שמרי עליו! 🏛️",
    "את בונה הרגלים שישרתו אותך לתמיד! 🔨",
    "השינה הטובה היא הבסיס להצלחה! 😴",
  ];
